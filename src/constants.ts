...
export const HOVER_LINK_SOURCE_ID = 'para-kanban';
...
export const CSS_CLASSES = {
	...
	COLUMN_HIDE_BTN: 'obk-column-hide-btn',
	HIDDEN_BAR: 'obk-hidden-bar',
	HIDDEN_BAR_LABEL: 'obk-hidden-bar-label',
	HIDDEN_CHIP: 'obk-hidden-chip',
